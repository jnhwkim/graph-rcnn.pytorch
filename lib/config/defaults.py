...
# Target fraction of RoI minibatch that is labeled foreground (i.e. class > 0)
_C.MODEL.ROI_RELATION_HEAD.POSITIVE_FRACTION = 0.5
...
# ---------------------------------------------------------------------------- #
# Specific LinkNet options
# ---------------------------------------------------------------------------- #
_C.MODEL.LINKNET = CN()
_C.MODEL.LINKNET.LABEL_EMBEDDING_SIZE = 200
_C.MODEL.LINKNET.HIDDEN_SIZE = 512
_C.MODEL.LINKNET.SATT_NUM_LAYERS = 2
_C.MODEL.LINKNET.SATT_HIDDEN_FACTOR = 2
_C.MODEL.LINKNET.SATT_DROPOUT_RATE = .1
_C.MODEL.LINKNET.OBJ_REL_EMBEDDING_SIZE = 256
_C.MODEL.LINKNET.GEOMETRIC_LAYOUT_SIZE = 4
