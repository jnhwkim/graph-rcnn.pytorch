...
_C.MODEL.ROI_RELATION_HEAD.IMP_FEATURE_UPDATE_STEP = 3
_C.MODEL.ROI_RELATION_HEAD.GRCNN_FEATURE_UPDATE_STEP = 2
_C.MODEL.ROI_RELATION_HEAD.GRCNN_SCORE_UPDATE_STEP = 2
